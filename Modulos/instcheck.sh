...
echo ""
echo -e "                 \033[1;31mBy @seth42sp\033[1;36m"
echo ""
...
sleep 5
cd /bin || exit
wget https://github.com/wellzin-blip/new2022/raw/script/Painel-V2022/chuser > /dev/null 2>&1
wget https://github.com/wellzin-blip/new2022/raw/script/Painel-V2022/userscheck > /dev/null 2>&1
chmod 777 chuser > /dev/null 2>&1
chmod 777 userscheck > /dev/null 2>&1
clear
mkdir /etc/rec > /dev/null 2>&1
echo -e 'By: @seth42sp' > /etc/rec/licence
echo -e 'By: @seth42sp' > /usr/lib/licence
mkdir /usr/lib/checkuser > /dev/null 2>&1
cd /usr/lib/checkuser || exit
rm checkuser.py > /dev/null 2>&1
wget https://github.com/wellzin-blip/new2022/raw/script/Painel-V2022/checkuser.py > /dev/null 2>&1
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@seth42sp\033[0m"
